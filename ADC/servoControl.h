...
#define SERVO_MIN_PULSE 55//55-> for esc
#define SERVO_MAX_PULSE 95//90-> for esc
...
/*****************************************************
 * @Function servoSetWidthValue()
 * @param pulse width want between 1 and 2
 * @return 1 on SUCCESS 0 on FAILURE
 *
 * @brief This function is a wrapper function that will in desired pulse widht and do necceasyr sys calls
 * 		  to control servo
 ...
 *
 *****************************************************/
uint8_t servoSetWidthValue(int var);
 ...
 * @return 1 on SUCCESS 0 on FAILURE
 *
 * @brief This function is a wrapper function that will in desired pulse widht and do neccesary sys calls
 * 		  to control servo
 * @note
 * @author Luis Gonzalez, 2/13
 *
