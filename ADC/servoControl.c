 ...
 * @return 1 on SUCCESS 0 on FAILURE
 *
 * @brief This function is a wrapper function that will in desired pulse width and do necceasyr sys calls
 * 		  to control servo
 * @note
 * @author Kenny 2/19
 *
...
uint8_t servoSetWidthValue(int var){
	...
	ui8Adjust = ((SERVO_MAX_PULSE - SERVO_MIN_PULSE)*var)/(4096) + SERVO_MIN_PULSE;
